...
async function productListApi(){
    const conexao = await fetch("https://6695a2d80312447373bfaac8.mockapi.io/api/v1"); //fazer a conexao com a API
...
async function criarElementoCard(name, price, imagem, id){
    const conexao = await fetch("https://6695a2d80312447373bfaac8.mockapi.io/api/v1", {
        method: "POST", 
        headers: {
